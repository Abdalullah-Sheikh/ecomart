            ...
            <div class="row">
               ...
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="footer-widget footer1-widget footer1-widget2 mb-40">
                     ...
                     <ul>
                        <li><a href="shop.php">Handbags & Wallets</a></li>
                        <li><a href="shop.php">Women's Clothing</a></li>
                        <li><a href="shop.php">Plus Sizes</a></li>
                        <li><a href="shop.php">Complete Your Look</a></li>
                        <li><a href="shop.php">Baby Corner</a></li>
                        <li><a href="shop.php">Man & Woman Shoe</a></li>
                     </ul>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
