...
<body>
   ...
   <header class="header1">
      ...
      <!-- faq form start -->
      <section class="faq-form pt-50 pb-120">
         <div class="container container-small">
            <div class="row">
               <div class="col-12">
                  <div class="section-title text-center">
                     <h2 class="section-main-title mb-50">Still stuck ask directly</h2>
                  </div>
               </div>
            </div>
            <div class="row justify-content-center">
               <div class="col-lg-8">
                  <div class="contact-form">
                     <form action="https://themepure.net/php/ecomart-prev/ecomart/mail.php" id="contact-form" method="POST">
                        <div class="row">
                           ...
                           <div class="col-xxl-12 col-xl-12">
                              <button type="submit" class="fill-btn">Send message</button>
                           </div>
                        </div>
                     </form>
