...
<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Panel</span>
              ...
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">Charts</span>
            </a>
					</li>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="userData.php">
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">User Data</span>
            </a>
					</li>
